...
s = pygame.Surface( ( screenHeight, screenWidth ) )
s.set_alpha( 48 )
s.fill( ( 255, 0, 0 ) )
...
def drawLivesMessage():
    
    x = 65
    xo = 750 - x
    
    for i in range( player.lives ):
        win.blit( heartimg, ( xo, 690 ) )
        xo -= x
...
def gameLevel():
    ...
    # 2. floating
    # 3. + faster asteroids
    # 4. + slower score increment + faster asteroids
    # 5. 2,1,1,1 asteroids
    ...
    while len( asteroid_sprites ) != asteroids:
        asteroid_sprites.add( Ball( ballVel ) )
            ...
            if( randint( 0, 3 ) == 0 ): # LEFT
                if player.rect.x > 7:
                    for i in range(7):
                        ...
                        background.x -= 0.1
            if( randint( 0, 3 ) == 0 ): # RIGHT
                if player.rect.x < screenWidth - player.rect.width - 7:
                    for i in range(7):
                        player.rect.x += 1
                        background.x += 0.1
            ...
            if( randint( 0, 1 ) == 0 ): # UP
                if player.rect.y > 5:
                    for i in range(5):
                        ...
                        background.y -= 0.1
            if( randint( 0, 1 ) == 0 ): # DOWN
                if player.rect.y < screenHeight - player.rect.height - 5:
                    for i in range(5):
                        player.rect.y += 1
                        background.y += 0.1
            if( randint( 0, 3 ) == 0 ): # LEFT
                if player.rect.x > 9:
                    for i in range(9):
                        ...
                        background.x -= 0.1
            if( randint( 0, 3 ) == 0 ): # RIGHT
                if player.rect.x < screenWidth - player.rect.width - 9:
                    for i in range(9):
                        player.rect.x += 1
                        background.x += 0.1
